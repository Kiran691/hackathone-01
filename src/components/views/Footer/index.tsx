        ...
        <div className="space-y-6 w-64 flex-shrink-0 md:mx-0 mx-auto text-start md:text-left">
          ...
          >
            <Image
              ...
              height={150}
              src={
                "https://full-stack-ecommerce-clothing-web.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FLogo.3267fed8.png&w=384&q=75"
              }
              alt="Logo"
            />
          </Link>
        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-start">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 space-y-4">
              ...
              <li>
                <a className="text-gray-700 hover:text-gray-800">Contact Us</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 space-y-4">
              ...
              <li>
                <a className="text-gray-700 hover:text-gray-800">24h Service</a>
              </li>
              <li>
                <a className="text-gray-700 hover:text-gray-800">Quick Chat</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10 space-y-4">
              <li>
                <a className="text-gray-700 hover:text-gray-800">Whatsapp</a>
              </li>
              <li>
                <a className="text-gray-700 hover:text-gray-800">Support 24h</a>
              </li>
            </nav>
          </div>
        </div>
